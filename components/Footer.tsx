      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8 md:mb-10">
          <div className="sm:col-span-2 md:col-span-1">
            ...
            <p className="text-white/50 text-base mt-3 leading-relaxed max-w-xs">
          ...
          <div>
            <h3 className="font-semibold text-base mb-4 text-white/90">Marketplace</h3>
          ...
          <div>
            <h3 className="font-semibold text-base mb-4 text-white/90">Learn</h3>
            <ul className="space-y-2.5 text-white/50 text-base">
          ...
          <div>
            <h3 className="font-semibold text-base mb-4 text-white/90">Download App</h3>
            <a
